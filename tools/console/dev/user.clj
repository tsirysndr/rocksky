(ns user
  ...
  (:require [console.core      :as c]
            ...
            [console.remote-ws :as remote-ws]
            [console.deezer    :as deezer]
...
(let [n (try (env/load!) (catch Exception _ nil))]
  ...
  (println "Aliases in scope: c, sh, env, lexgen, db, sync, daemons, remote, remote-ws, deezer, devops, docker, cron")
  (when n
