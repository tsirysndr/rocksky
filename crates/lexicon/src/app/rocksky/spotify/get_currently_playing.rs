...
pub const NSID: &str = "app.rocksky.spotify.getCurrentlyPlaying";
...
pub struct Parameters {
    ...
    /// If not provided, defaults to the current user. Format: `at-identifier`.
...
/// The response body.
pub type Output =
    super::super::super::super::app::rocksky::player::defs::CurrentlyPlayingViewDetailed;
