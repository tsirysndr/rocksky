...
pub const NSID: &str = "app.rocksky.actor.getActorArtists";
...
pub struct Parameters {
    ...
    pub did: String,
    /// The end date to filter albums to (ISO 8601 format) Format: `datetime`.
    ...
    /// The start date to filter albums from (ISO 8601 format) Format:
    /// `datetime`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
