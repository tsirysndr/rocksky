...
pub const NSID: &str = "app.rocksky.graph.getFollows";
...
pub struct Parameters {
    ...
    /// If provided, filters the follows to only include those with DIDs in this
    /// list.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Output {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cursor: Option<String>,
    pub follows: Vec<super::super::super::super::app::rocksky::actor::defs::ProfileViewBasic>,
