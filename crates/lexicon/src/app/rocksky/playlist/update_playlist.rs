...
pub const NSID: &str = "app.rocksky.playlist.updatePlaylist";
...
pub struct Parameters {
    ...
    /// The new cover image URL for the playlist Format: `uri`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub picture_url: Option<String>,
    /// The URI of the playlist to update Format: `at-uri`.
    pub uri: String,
}
...
pub struct Output {
    ...
    pub cid: String,
    /// The AT-URI of the updated app.rocksky.playlist record. Format: `at-uri`.
    pub uri: String,
}
