...
pub struct Input {
    ...
    pub crossfade:
        Option<super::super::super::super::app::rocksky::rockbox::defs::CrossfadeSettings>,
    /// Equalizer settings to apply.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub equalizer:
        Option<super::super::super::super::app::rocksky::rockbox::defs::EqualizerSettings>,
    /// Replay gain settings to apply.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replay_gain:
        Option<super::super::super::super::app::rocksky::rockbox::defs::ReplayGainSettings>,
    /// Tone control settings to apply.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tone: Option<super::super::super::super::app::rocksky::rockbox::defs::ToneSettings>,
}
