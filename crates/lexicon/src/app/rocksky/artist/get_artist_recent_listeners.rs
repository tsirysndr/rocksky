...
pub const NSID: &str = "app.rocksky.artist.getArtistRecentListeners";
...
pub struct Parameters {
    ...
    /// The URI of the artist to retrieve recent listeners from Format:
    /// `at-uri`.
    pub uri: String,
}
...
pub struct Output {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub listeners:
        Option<Vec<super::super::super::super::app::rocksky::artist::defs::RecentListenerView>>,
}
