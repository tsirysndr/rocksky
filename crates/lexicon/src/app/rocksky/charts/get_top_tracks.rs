...
pub const NSID: &str = "app.rocksky.charts.getTopTracks";
...
pub struct Parameters {
    ...
    /// The end date to filter tracks to (ISO 8601 format) Format: `datetime`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// The start date to filter tracks from (ISO 8601 format) Format:
    /// `datetime`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
