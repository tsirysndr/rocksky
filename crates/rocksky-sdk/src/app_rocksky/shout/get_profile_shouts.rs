...
impl<S: BosStr> GetProfileShouts<S> {
    ...
    pub fn builder() -> GetProfileShoutsBuilder<get_profile_shouts_state::Empty, S> {
        GetProfileShoutsBuilder::builder()
    }
}

impl GetProfileShoutsBuilder<get_profile_shouts_state::Empty, DefaultStr> {
...
impl<S: BosStr> GetProfileShoutsBuilder<get_profile_shouts_state::Empty, S> {
...
impl<St, S: BosStr> GetProfileShoutsBuilder<St, S>
where
    ...
    St::Did: get_profile_shouts_state::IsUnset,
{
    ...
    ) -> GetProfileShoutsBuilder<get_profile_shouts_state::SetDid<St>, S> {
...
impl<St: get_profile_shouts_state::State, S: BosStr> GetProfileShoutsBuilder<St, S> {
