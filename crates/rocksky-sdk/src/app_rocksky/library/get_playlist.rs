...
//
// Lexicon: app.rocksky.library.getPlaylist
//
...
/** Response marker for the `app.rocksky.library.getPlaylist` query.
...
impl jacquard_common::xrpc::XrpcResp for GetPlaylistResponse {
    const NSID: &'static str = "app.rocksky.library.getPlaylist";
...
/** Endpoint marker for the `app.rocksky.library.getPlaylist` query.

Path: `/xrpc/app.rocksky.library.getPlaylist`. The request payload type is `GetPlaylist<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct GetPlaylistRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetPlaylistRequest {
    const PATH: &'static str = "/xrpc/app.rocksky.library.getPlaylist";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
...
where
    ...
    St::Id: get_playlist_state::IsUnset,
{
    /// Set the `id` field (required)
    pub fn id(
        mut self,
        value: impl Into<S>,
    ) -> GetPlaylistBuilder<get_playlist_state::SetId<St>, S> {
...
where
    St: get_playlist_state::State,
    St::Id: get_playlist_state::IsSet,
{
