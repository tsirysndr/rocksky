...
/** Response marker for the `app.rocksky.player.getCurrentlyPlaying` query.
...
/** Endpoint marker for the `app.rocksky.player.getCurrentlyPlaying` query.

Path: `/xrpc/app.rocksky.player.getCurrentlyPlaying`. The request payload type is `GetCurrentlyPlaying<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
