...
<Frame>
  <img src="/images/integrations/scrobble-api-local.png" alt="`npx @rocksky/cli scrobble-api` running in a terminal, syncing scrobbles and connecting to JetStream" />
</Frame>
