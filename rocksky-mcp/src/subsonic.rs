...
use crate::creds::{navidrome_creds, NavidromeCreds};

/// Rocksky's library server. Not configurable: a Rocksky account's library
/// lives here and nowhere else, and the Subsonic credentials
/// ([`navidrome_creds`]) are minted against this host specifically.
const NAVIDROME_URL: &str = "https://navidrome.rocksky.app";
...
impl Subsonic {
    ...
    pub async fn connect(api_url: &str, token: &str) -> Result<Subsonic> {
