...
function ProviderRow({ provider, onDelete }: { provider: StorageProvider; onDelete: (id: string) => void }) {
      ...
      >
        ...
        <ModalBody>
          <p className="text-sm m-0" style={{ color: "var(--color-text-muted)" }}>
            This only removes the connection. Files already uploaded to{" "}
        ...
        <ModalFooter>
          ...
          <Button
            ...
            overrides={{
              BaseButton: { style: { backgroundColor: "#dc2626 !important", color: "#fff !important" } },
            }}
          >
            Remove
          </Button>
    ...
    <Main>
      <div className="px-4 pt-4 pb-24">
        ...
        <div
          ...
          style={{ backgroundColor: "var(--color-surface)", border: "1px solid var(--color-border)" }}
        >
          <IconLock size={16} color="var(--color-text-muted)" className="shrink-0 mt-0.5" />
          <p className="text-xs m-0" style={{ color: "var(--color-text-muted)" }}>
            Credentials are encrypted at rest using XSalsa20-Poly1305 and are never returned by the API.
          </p>
        </div>
        ...
        {providers.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            ...
            <p className="text-sm text-center m-0" style={{ color: "var(--color-text-muted)" }}>
              No storage providers connected yet.{"\n"}Uploads use Rocksky managed storage by default.
            </p>
          </div>
        )}
          ...
          <ModalBody>
            <div className="flex flex-col gap-3">
              ...
              <FormControl
                ...
                caption="Optional. If set, audio streams directly from your CDN. Otherwise Rocksky generates presigned URLs."
              >
                <Controller
                  name="public_url"
                  control={control}
