...
import type * as FmTealFeedDefs from "./defs";
...
export function isRecord(v: unknown): v is Record {
  return (
    isObj(v) &&
    hasProp(v, "$type") &&
    (v.$type === "fm.teal.feed.play#main" || v.$type === "fm.teal.feed.play")
  );
}

export function validateRecord(v: unknown): ValidationResult {
  return lexicons.validate("fm.teal.feed.play#main", v);
}
