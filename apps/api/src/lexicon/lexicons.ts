...
export const schemaDict = {
    ...
    defs: {
      ...
      notificationView: {
        ...
        properties: {
          ...
          subject: {
            type: "ref",
            ref: "lex:app.rocksky.notification.defs#subjectView",
          },
        },
      },
      subjectView: {
        ...
        properties: {
          ...
          title: {
            type: "string",
            description: "The title of the track or album.",
          },
          artist: {
            type: "string",
            description: "The artist of the track or album.",
          },
          albumArt: {
            type: "string",
            description: "The album art image URL.",
            format: "uri",
          },
        },
      },
    ...
    defs: {
      ...
      wrappedArtist: {
        ...
        properties: {
          ...
          playCount: {
            type: "integer",
            description: "Number of plays in the wrapped period.",
            minimum: 0,
          },
        },
      },
      ...
      wrappedGenreCount: {
        ...
        properties: {
          ...
          count: {
            type: "integer",
            description: "Number of scrobbles for this genre.",
            minimum: 0,
          },
        },
      },
      wrappedMonthCount: {
        ...
        properties: {
          ...
          count: {
            type: "integer",
            description: "Number of scrobbles in this month.",
            minimum: 0,
          },
        },
      },
      wrappedDayCount: {
        ...
        properties: {
          ...
          count: {
            type: "integer",
            description: "Number of scrobbles on this day.",
            minimum: 0,
          },
        },
      },
      ...
      wrappedView: {
        ...
        properties: {
          ...
          topArtists: {
            type: "array",
            description: "Top 5 artists by play count.",
            items: {
              type: "ref",
              ref: "lex:app.rocksky.stats.defs#wrappedArtist",
            },
          },
          topTracks: {
            type: "array",
            description: "Top 5 tracks by play count.",
            items: {
              type: "ref",
              ref: "lex:app.rocksky.stats.defs#wrappedTrack",
            },
          },
          topAlbums: {
            type: "array",
          ...
          topGenres: {
            type: "array",
            description: "Top genres by play count.",
            items: {
              type: "ref",
              ref: "lex:app.rocksky.stats.defs#wrappedGenreCount",
            },
          },
          scrobblesPerMonth: {
            type: "array",
            description: "Scrobble counts per month.",
            items: {
              type: "ref",
          ...
          mostActiveDay: {
            type: "ref",
            description: "The most active day of the year.",
            ref: "lex:app.rocksky.stats.defs#wrappedDayCount",
          },
          mostActiveHour: {
            type: "integer",
            description: "The most active hour of the day (0-23).",
            maximum: 23,
            minimum: 0,
          },
          newArtistsCount: {
          ...
          firstScrobble: {
            type: "ref",
            description: "The first scrobble of the year.",
            ref: "lex:app.rocksky.stats.defs#wrappedMilestone",
          },
          lastScrobble: {
            type: "ref",
            description: "The last scrobble of the year.",
            ref: "lex:app.rocksky.stats.defs#wrappedMilestone",
          },
        },
      },
  ...
  AppRockskyStatsGetWrapped: {
    lexicon: 1,
    id: "app.rocksky.stats.getWrapped",
    defs: {
      main: {
        type: "query",
        ...
        output: {
          ...
          schema: {
            type: "ref",
            ref: "lex:app.rocksky.stats.defs#wrappedView",
          },
        },
      },
    },
