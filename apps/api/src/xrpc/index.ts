...
import getUnreadCount from "./app/rocksky/notification/getUnreadCount";
...
import addSongs from "./app/rocksky/playlist/addSongs";
...
import getSongRecentListeners from "./app/rocksky/song/getSongRecentListeners";
...
import getGlobalStats from "./app/rocksky/stats/getGlobalStats";
...
export default function (server: Server, ctx: Context) {
  ...
  getSong(server, ctx);
  getSongRecentListeners(server, ctx);
  getSongs(server, ctx);
