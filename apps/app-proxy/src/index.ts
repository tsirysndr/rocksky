...
const metadata = {
	...
	scope:
		'atproto repo:app.rocksky.album repo:app.rocksky.artist repo:app.rocksky.graph.follow repo:app.rocksky.like repo:app.rocksky.playlist repo:app.rocksky.scrobble repo:app.rocksky.shout repo:app.rocksky.song repo:app.rocksky.feed.generator repo:fm.teal.feed.play repo:fm.teal.actor.status repo:fm.teal.alpha.feed.play repo:fm.teal.alpha.actor.status repo:app.rocksky.actor.status repo:app.rocksky.rockbox.audio.settings',
